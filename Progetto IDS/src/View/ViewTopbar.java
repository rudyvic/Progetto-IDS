...
public class ViewTopbar extends Observable implements Observer, ActionListener {
	...
	/*
	public void setAutenticato(boolean isAutenticato) {
		this.isAutenticato = isAutenticato;
		refreshEastPanel();
	}
	
	public void setPersonale(boolean isPersonale) {
		this.isPersonale = isPersonale;
		refreshEastPanel();
	}
	
	public void setSuperUtente(boolean isSuperUtente) {
		this.isSuperUtente = isSuperUtente;
		refreshEastPanel();
	}
	...
	public void refreshEastPanel() {
		...
		if(isAutenticato==false) {
			...
			panelEast = adminPanel;
			((JLabel)adminPanel.getComponent(0)).setText(username);
			controller.showHome();
		}
...
*/	
	...
	public void setCartEmpty(boolean isEmpty) {
		if(isEmpty == true) {
